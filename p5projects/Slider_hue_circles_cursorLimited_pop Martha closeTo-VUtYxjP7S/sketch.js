...
function mouseClicked() {
  // When deleing best to count down
  // for (let i = 0; i < circles.length; i++) {
  //   circles[i].popped();
  // }
  console.log('mouseClicked start')
  for (let i = circles.length-1; i >= 0; i--) {
    let item = circles[i];
    let test = item.closeTo(mouseX, mouseY);
    if (test) {
      console.log('closeTo i', i);
      circles.splice(i, 1);
    }
  }
}
...
// https://editor.p5js.org/jht1493/sketches/VUtYxjP7S
